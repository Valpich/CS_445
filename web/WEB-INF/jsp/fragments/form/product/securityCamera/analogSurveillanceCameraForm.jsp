...
<div class="container">
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <spring:url value="/analogSurveillanceCameraUpdate" var="analog"/>
        </c:otherwise>
    </c:choose>
    ...
    <form action='${analog}' method="POST">
        ...
        <div class="col-sm-10">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <input hidden type="text" name="id" value="${analogSurveillanceCameraFormUpdate.id}">
                </c:otherwise>
            </c:choose>
        ...
        <div class="col-sm-10">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <input type="number" step="0.01" name="price" value="${analogSurveillanceCameraFormUpdate.price}" placeholder="">
                </c:otherwise>
            </c:choose>
