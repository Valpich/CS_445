...
<div class="container">
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <spring:url value="/digitalSurveillanceCameraUpdate" var="digital"/>
        </c:otherwise>
    </c:choose>
    ...
    <form action='${digital}' method="POST">
        ...
        <div class="col-sm-10">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <input hidden type="text" name="id" value="${digitalSurveillanceCameraFormUpdate.id}">
                </c:otherwise>
            </c:choose>
        ...
        <div class="col-sm-10">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <input type="number" step="0.01" name="price" value="${digitalSurveillanceCameraFormUpdate.price}" placeholder="">
                </c:otherwise>
            </c:choose>
