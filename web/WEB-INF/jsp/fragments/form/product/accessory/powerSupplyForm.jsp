...
<div class="container">
    ...
    <form action='${powerSupply}' method="POST">
        ...
        <div class="col-sm-10">
            ...
            <c:choose>
                <c:when test="${not empty powerSupplyForm}">
                    <input type="number" step="0.01" name="voltage" placeholder="">
                </c:when>
                <c:otherwise>
                    <input type="number" step="0.01" name="voltage" value="${powerSupplyFormUpdate.voltage}" placeholder="">
                </c:otherwise>
            </c:choose>
        ...
        <div class="col-sm-10">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <input type="number" step="0.01" name="price" value="${powerSupplyFormUpdate.price}" placeholder="">
                </c:otherwise>
            </c:choose>
